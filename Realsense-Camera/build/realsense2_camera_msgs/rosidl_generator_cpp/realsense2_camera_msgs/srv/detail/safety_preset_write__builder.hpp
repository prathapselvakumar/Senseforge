...
class Init_SafetyPresetWrite_Event_response
{
public:
  explicit Init_SafetyPresetWrite_Event_response(::realsense2_camera_msgs::srv::SafetyPresetWrite_Event & msg)
  : msg_(msg)
  {}
  ::realsense2_camera_msgs::srv::SafetyPresetWrite_Event response(::realsense2_camera_msgs::srv::SafetyPresetWrite_Event::_response_type arg)
  {
...
private:
  ::realsense2_camera_msgs::srv::SafetyPresetWrite_Event msg_;
};

class Init_SafetyPresetWrite_Event_request
{
public:
  explicit Init_SafetyPresetWrite_Event_request(::realsense2_camera_msgs::srv::SafetyPresetWrite_Event & msg)
  : msg_(msg)
  {}
  Init_SafetyPresetWrite_Event_response request(::realsense2_camera_msgs::srv::SafetyPresetWrite_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SafetyPresetWrite_Event_response(msg_);
  }
...
class Init_SafetyPresetWrite_Event_info
{
public:
  Init_SafetyPresetWrite_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SafetyPresetWrite_Event_request info(::realsense2_camera_msgs::srv::SafetyPresetWrite_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SafetyPresetWrite_Event_request(msg_);
  }
...
template<>
inline
auto build<::realsense2_camera_msgs::srv::SafetyPresetWrite_Event>()
{
  return realsense2_camera_msgs::srv::builder::Init_SafetyPresetWrite_Event_info();
}
