...
class Metaclass_SafetyPresetRead_Event(type):
    """Metaclass of message 'SafetyPresetRead_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__safety_preset_read__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__safety_preset_read__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__safety_preset_read__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__safety_preset_read__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__safety_preset_read__event
...
class SafetyPresetRead_Event(metaclass=Metaclass_SafetyPresetRead_Event):
    """Message class 'SafetyPresetRead_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<realsense2_camera_msgs/SafetyPresetRead_Request, 1>',
        'response': 'sequence<realsense2_camera_msgs/SafetyPresetRead_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['realsense2_camera_msgs', 'srv'], 'SafetyPresetRead_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['realsense2_camera_msgs', 'srv'], 'SafetyPresetRead_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from realsense2_camera_msgs.srv import SafetyPresetRead_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SafetyPresetRead_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SafetyPresetRead_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from realsense2_camera_msgs.srv import SafetyPresetRead_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SafetyPresetRead_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SafetyPresetRead_Response'"
...
class Metaclass_SafetyPresetRead(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _safety_preset_read.Metaclass_SafetyPresetRead_Event._TYPE_SUPPORT is None:
                _safety_preset_read.Metaclass_SafetyPresetRead_Event.__import_type_support__()
...
class SafetyPresetRead(metaclass=Metaclass_SafetyPresetRead):
    ...
    from realsense2_camera_msgs.srv._safety_preset_read import SafetyPresetRead_Event as Event
