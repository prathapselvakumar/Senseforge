...
class Metaclass_HardwareMonitorCommandSend_Event(type):
    """Metaclass of message 'HardwareMonitorCommandSend_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__hardware_monitor_command_send__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__hardware_monitor_command_send__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__hardware_monitor_command_send__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__hardware_monitor_command_send__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__hardware_monitor_command_send__event
...
class HardwareMonitorCommandSend_Event(metaclass=Metaclass_HardwareMonitorCommandSend_Event):
    """Message class 'HardwareMonitorCommandSend_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<realsense2_camera_msgs/HardwareMonitorCommandSend_Request, 1>',
        'response': 'sequence<realsense2_camera_msgs/HardwareMonitorCommandSend_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['realsense2_camera_msgs', 'srv'], 'HardwareMonitorCommandSend_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['realsense2_camera_msgs', 'srv'], 'HardwareMonitorCommandSend_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from realsense2_camera_msgs.srv import HardwareMonitorCommandSend_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, HardwareMonitorCommandSend_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'HardwareMonitorCommandSend_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from realsense2_camera_msgs.srv import HardwareMonitorCommandSend_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, HardwareMonitorCommandSend_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'HardwareMonitorCommandSend_Response'"
...
class Metaclass_HardwareMonitorCommandSend(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _hardware_monitor_command_send.Metaclass_HardwareMonitorCommandSend_Event._TYPE_SUPPORT is None:
                _hardware_monitor_command_send.Metaclass_HardwareMonitorCommandSend_Event.__import_type_support__()
...
class HardwareMonitorCommandSend(metaclass=Metaclass_HardwareMonitorCommandSend):
    ...
    from realsense2_camera_msgs.srv._hardware_monitor_command_send import HardwareMonitorCommandSend_Event as Event
