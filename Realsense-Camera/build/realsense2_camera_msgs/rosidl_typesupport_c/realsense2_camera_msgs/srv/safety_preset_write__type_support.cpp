...
static const _SafetyPresetWrite_Event_type_support_symbol_names_t _SafetyPresetWrite_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, realsense2_camera_msgs, srv, SafetyPresetWrite_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, realsense2_camera_msgs, srv, SafetyPresetWrite_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, realsense2_camera_msgs, srv, SafetyPresetWrite_Event)() {
  return &::realsense2_camera_msgs::srv::rosidl_typesupport_c::SafetyPresetWrite_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SafetyPresetWrite_service_type_support_handle = {
  ...
  &SafetyPresetWrite_Request_message_type_support_handle,
  &SafetyPresetWrite_Response_message_type_support_handle,
  &SafetyPresetWrite_Event_message_type_support_handle,
