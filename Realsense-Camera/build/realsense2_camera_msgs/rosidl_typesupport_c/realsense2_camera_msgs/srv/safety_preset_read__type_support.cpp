...
static const _SafetyPresetRead_Event_type_support_symbol_names_t _SafetyPresetRead_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, realsense2_camera_msgs, srv, SafetyPresetRead_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, realsense2_camera_msgs, srv, SafetyPresetRead_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, realsense2_camera_msgs, srv, SafetyPresetRead_Event)() {
  return &::realsense2_camera_msgs::srv::rosidl_typesupport_c::SafetyPresetRead_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SafetyPresetRead_service_type_support_handle = {
  ...
  &SafetyPresetRead_Request_message_type_support_handle,
  &SafetyPresetRead_Response_message_type_support_handle,
  &SafetyPresetRead_Event_message_type_support_handle,
