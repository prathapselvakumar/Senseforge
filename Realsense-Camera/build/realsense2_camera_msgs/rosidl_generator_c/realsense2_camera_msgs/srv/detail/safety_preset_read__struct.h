...
enum
{
  realsense2_camera_msgs__srv__SafetyPresetRead_Event__request__MAX_SIZE = 1
};
// response
enum
{
  realsense2_camera_msgs__srv__SafetyPresetRead_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SafetyPresetRead in the package realsense2_camera_msgs.
typedef struct realsense2_camera_msgs__srv__SafetyPresetRead_Event
{
  service_msgs__msg__ServiceEventInfo info;
  realsense2_camera_msgs__srv__SafetyPresetRead_Request__Sequence request;
  realsense2_camera_msgs__srv__SafetyPresetRead_Response__Sequence response;
} realsense2_camera_msgs__srv__SafetyPresetRead_Event;

// Struct for a sequence of realsense2_camera_msgs__srv__SafetyPresetRead_Event.
typedef struct realsense2_camera_msgs__srv__SafetyPresetRead_Event__Sequence
{
