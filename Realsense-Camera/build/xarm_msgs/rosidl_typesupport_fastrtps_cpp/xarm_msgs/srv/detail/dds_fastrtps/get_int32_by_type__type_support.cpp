...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_xarm_msgs
max_serialized_size_key_GetInt32ByType_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_xarm_msgs
max_serialized_size_key_GetInt32ByType_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
// functions for xarm_msgs::srv::GetInt32ByType_Request already declared above

// functions for xarm_msgs::srv::GetInt32ByType_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_xarm_msgs
cdr_serialize(
  const xarm_msgs::srv::GetInt32ByType_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  xarm_msgs::srv::GetInt32ByType_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_xarm_msgs
max_serialized_size_GetInt32ByType_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        xarm_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_GetInt32ByType_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        xarm_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_GetInt32ByType_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xarm_msgs::srv::GetInt32ByType_Event;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_xarm_msgs
max_serialized_size_key_GetInt32ByType_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        xarm_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetInt32ByType_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        xarm_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetInt32ByType_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const xarm_msgs::srv::GetInt32ByType_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<xarm_msgs::srv::GetInt32ByType_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetInt32ByType_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const xarm_msgs::srv::GetInt32ByType_Event *>(
...
static size_t _GetInt32ByType_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetInt32ByType_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetInt32ByType_Event__callbacks = {
  "xarm_msgs::srv",
...
static rosidl_message_type_support_t _GetInt32ByType_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetInt32ByType_Event__callbacks,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_xarm_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<xarm_msgs::srv::GetInt32ByType_Event>()
{
  return &xarm_msgs::srv::typesupport_fastrtps_cpp::_GetInt32ByType_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xarm_msgs, srv, GetInt32ByType_Event)() {
  return &xarm_msgs::srv::typesupport_fastrtps_cpp::_GetInt32ByType_Event__handle;
}
...
static const rosidl_service_type_support_t _GetInt32ByType__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetInt32ByType__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<xarm_msgs::srv::GetInt32ByType_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<xarm_msgs::srv::GetInt32ByType_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<xarm_msgs::srv::GetInt32ByType_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<xarm_msgs::srv::GetInt32ByType>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<xarm_msgs::srv::GetInt32ByType>,
