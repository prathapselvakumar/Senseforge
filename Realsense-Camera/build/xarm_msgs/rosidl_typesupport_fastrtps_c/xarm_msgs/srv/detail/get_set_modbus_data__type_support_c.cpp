...
bool cdr_serialize_xarm_msgs__srv__GetSetModbusData_Request(
  const xarm_msgs__srv__GetSetModbusData_Request * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
bool cdr_deserialize_xarm_msgs__srv__GetSetModbusData_Request(
  eprosima::fastcdr::Cdr & cdr,
  xarm_msgs__srv__GetSetModbusData_Request * ros_message)
{
  // Field name: modbus_data
  {
    uint32_t cdrSize;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
bool cdr_serialize_key_xarm_msgs__srv__GetSetModbusData_Request(
  const xarm_msgs__srv__GetSetModbusData_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: modbus_data
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
size_t get_serialized_size_key_xarm_msgs__srv__GetSetModbusData_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetSetModbusData_Request__ros_msg_type * ros_message = static_cast<const _GetSetModbusData_Request__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
size_t max_serialized_size_key_xarm_msgs__srv__GetSetModbusData_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const xarm_msgs__srv__GetSetModbusData_Request * ros_message = static_cast<const xarm_msgs__srv__GetSetModbusData_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_xarm_msgs__srv__GetSetModbusData_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  xarm_msgs__srv__GetSetModbusData_Request * ros_message = static_cast<xarm_msgs__srv__GetSetModbusData_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_xarm_msgs__srv__GetSetModbusData_Request(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
bool cdr_serialize_xarm_msgs__srv__GetSetModbusData_Response(
  const xarm_msgs__srv__GetSetModbusData_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: ret
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
bool cdr_deserialize_xarm_msgs__srv__GetSetModbusData_Response(
  eprosima::fastcdr::Cdr & cdr,
  xarm_msgs__srv__GetSetModbusData_Response * ros_message)
{
  // Field name: ret
  {
    cdr >> ros_message->ret;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
bool cdr_serialize_key_xarm_msgs__srv__GetSetModbusData_Response(
  const xarm_msgs__srv__GetSetModbusData_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: ret
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
size_t get_serialized_size_key_xarm_msgs__srv__GetSetModbusData_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetSetModbusData_Response__ros_msg_type * ros_message = static_cast<const _GetSetModbusData_Response__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
size_t max_serialized_size_key_xarm_msgs__srv__GetSetModbusData_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const xarm_msgs__srv__GetSetModbusData_Response * ros_message = static_cast<const xarm_msgs__srv__GetSetModbusData_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_xarm_msgs__srv__GetSetModbusData_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  xarm_msgs__srv__GetSetModbusData_Response * ros_message = static_cast<xarm_msgs__srv__GetSetModbusData_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_xarm_msgs__srv__GetSetModbusData_Response(cdr, ros_message);
}
...
using _GetSetModbusData_Event__ros_msg_type = xarm_msgs__srv__GetSetModbusData_Event;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
bool cdr_serialize_xarm_msgs__srv__GetSetModbusData_Event(
  const xarm_msgs__srv__GetSetModbusData_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_xarm_msgs__srv__GetSetModbusData_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_xarm_msgs__srv__GetSetModbusData_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
bool cdr_deserialize_xarm_msgs__srv__GetSetModbusData_Event(
  eprosima::fastcdr::Cdr & cdr,
  xarm_msgs__srv__GetSetModbusData_Event * ros_message)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      xarm_msgs__srv__GetSetModbusData_Request__Sequence__fini(&ros_message->request);
    }
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_xarm_msgs__srv__GetSetModbusData_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      xarm_msgs__srv__GetSetModbusData_Response__Sequence__fini(&ros_message->response);
    }
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_xarm_msgs__srv__GetSetModbusData_Response(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
size_t get_serialized_size_xarm_msgs__srv__GetSetModbusData_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetSetModbusData_Event__ros_msg_type * ros_message = static_cast<const _GetSetModbusData_Event__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  size_t initial_alignment = current_alignment;
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_xarm_msgs__srv__GetSetModbusData_Request(
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_xarm_msgs__srv__GetSetModbusData_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
size_t max_serialized_size_xarm_msgs__srv__GetSetModbusData_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_xarm_msgs__srv__GetSetModbusData_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_xarm_msgs__srv__GetSetModbusData_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xarm_msgs__srv__GetSetModbusData_Event;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
bool cdr_serialize_key_xarm_msgs__srv__GetSetModbusData_Event(
  const xarm_msgs__srv__GetSetModbusData_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_xarm_msgs__srv__GetSetModbusData_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_xarm_msgs__srv__GetSetModbusData_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
size_t get_serialized_size_key_xarm_msgs__srv__GetSetModbusData_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetSetModbusData_Event__ros_msg_type * ros_message = static_cast<const _GetSetModbusData_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_xarm_msgs__srv__GetSetModbusData_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_xarm_msgs__srv__GetSetModbusData_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
size_t max_serialized_size_key_xarm_msgs__srv__GetSetModbusData_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_xarm_msgs__srv__GetSetModbusData_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_xarm_msgs__srv__GetSetModbusData_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const xarm_msgs__srv__GetSetModbusData_Event * ros_message = static_cast<const xarm_msgs__srv__GetSetModbusData_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_xarm_msgs__srv__GetSetModbusData_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  xarm_msgs__srv__GetSetModbusData_Event * ros_message = static_cast<xarm_msgs__srv__GetSetModbusData_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_xarm_msgs__srv__GetSetModbusData_Event(cdr, ros_message);
}

static uint32_t _GetSetModbusData_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xarm_msgs__srv__GetSetModbusData_Event(
      untyped_ros_message, 0));
}
...
static size_t _GetSetModbusData_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xarm_msgs__srv__GetSetModbusData_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_GetSetModbusData_Event = {
  "xarm_msgs::srv",
...
static rosidl_message_type_support_t _GetSetModbusData_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GetSetModbusData_Event,
  get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xarm_msgs, srv, GetSetModbusData_Event)() {
  return &_GetSetModbusData_Event__type_support;
}
...
static rosidl_service_type_support_t GetSetModbusData__handle = {
  ...
  &_GetSetModbusData_Request__type_support,
  &_GetSetModbusData_Response__type_support,
  &_GetSetModbusData_Event__type_support,
