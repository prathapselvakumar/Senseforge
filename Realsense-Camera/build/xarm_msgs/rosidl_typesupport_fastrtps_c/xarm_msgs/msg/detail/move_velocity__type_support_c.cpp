...
bool cdr_serialize_xarm_msgs__msg__MoveVelocity(
  const xarm_msgs__msg__MoveVelocity * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
bool cdr_deserialize_xarm_msgs__msg__MoveVelocity(
  eprosima::fastcdr::Cdr & cdr,
  xarm_msgs__msg__MoveVelocity * ros_message)
{
  // Field name: speeds
  {
    uint32_t cdrSize;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
bool cdr_serialize_key_xarm_msgs__msg__MoveVelocity(
  const xarm_msgs__msg__MoveVelocity * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: speeds
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
size_t get_serialized_size_key_xarm_msgs__msg__MoveVelocity(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveVelocity__ros_msg_type * ros_message = static_cast<const _MoveVelocity__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xarm_msgs
size_t max_serialized_size_key_xarm_msgs__msg__MoveVelocity(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const xarm_msgs__msg__MoveVelocity * ros_message = static_cast<const xarm_msgs__msg__MoveVelocity *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_xarm_msgs__msg__MoveVelocity(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  xarm_msgs__msg__MoveVelocity * ros_message = static_cast<xarm_msgs__msg__MoveVelocity *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_xarm_msgs__msg__MoveVelocity(cdr, ros_message);
}
