...
class Init_VacuumGripperCtrl_Event_response
{
public:
  explicit Init_VacuumGripperCtrl_Event_response(::xarm_msgs::srv::VacuumGripperCtrl_Event & msg)
  : msg_(msg)
  {}
  ::xarm_msgs::srv::VacuumGripperCtrl_Event response(::xarm_msgs::srv::VacuumGripperCtrl_Event::_response_type arg)
  {
...
private:
  ::xarm_msgs::srv::VacuumGripperCtrl_Event msg_;
};

class Init_VacuumGripperCtrl_Event_request
{
public:
  explicit Init_VacuumGripperCtrl_Event_request(::xarm_msgs::srv::VacuumGripperCtrl_Event & msg)
  : msg_(msg)
  {}
  Init_VacuumGripperCtrl_Event_response request(::xarm_msgs::srv::VacuumGripperCtrl_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_VacuumGripperCtrl_Event_response(msg_);
  }
...
class Init_VacuumGripperCtrl_Event_info
{
public:
  Init_VacuumGripperCtrl_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_VacuumGripperCtrl_Event_request info(::xarm_msgs::srv::VacuumGripperCtrl_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_VacuumGripperCtrl_Event_request(msg_);
  }
...
template<>
inline
auto build<::xarm_msgs::srv::VacuumGripperCtrl_Event>()
{
  return xarm_msgs::srv::builder::Init_VacuumGripperCtrl_Event_info();
}
