...
// IWYU pragma: private, include "xarm_msgs/srv/iden_load.h"
...
enum
{
  xarm_msgs__srv__IdenLoad_Event__request__MAX_SIZE = 1
};
// response
enum
{
  xarm_msgs__srv__IdenLoad_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/IdenLoad in the package xarm_msgs.
typedef struct xarm_msgs__srv__IdenLoad_Event
{
  service_msgs__msg__ServiceEventInfo info;
  xarm_msgs__srv__IdenLoad_Request__Sequence request;
  xarm_msgs__srv__IdenLoad_Response__Sequence response;
} xarm_msgs__srv__IdenLoad_Event;

// Struct for a sequence of xarm_msgs__srv__IdenLoad_Event.
typedef struct xarm_msgs__srv__IdenLoad_Event__Sequence
{
  xarm_msgs__srv__IdenLoad_Event * data;
  /// The number of valid items in data
  size_t size;
  /// The number of allocated items in data
  size_t capacity;
} xarm_msgs__srv__IdenLoad_Event__Sequence;
