...
static const _LinearMotorSetPos_Event_type_support_symbol_names_t _LinearMotorSetPos_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xarm_msgs, srv, LinearMotorSetPos_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xarm_msgs, srv, LinearMotorSetPos_Event)),
  }
};
...
{
  return &::xarm_msgs::srv::rosidl_typesupport_cpp::LinearMotorSetPos_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, xarm_msgs, srv, LinearMotorSetPos_Event)() {
  return get_message_type_support_handle<xarm_msgs::srv::LinearMotorSetPos_Event>();
}
...
static const rosidl_service_type_support_t LinearMotorSetPos_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<xarm_msgs::srv::LinearMotorSetPos_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<xarm_msgs::srv::LinearMotorSetPos_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<xarm_msgs::srv::LinearMotorSetPos_Event>(),
